package eu.vicci.bciframework.controlapp.util.gyro;
...
public class GyroSensorReader implements SensorEventListener{
	...
	GyroSensorListener sensorListener;
	Context context;

	public GyroSensorReader(Context context, GyroSensorListener gsl) {
		this.sensorListener = gsl;
	...
	public void onSensorChanged(SensorEvent event) {
		...
		if (mGravity != null && mMagnetic != null) {
			synchronized (this) {
				...
				sensorListener.onSensorData(xValue, yValue);
			}
		}
	}
