package eu.vicci.bciframework.controlapp.view;

import eu.vicci.bciframework.controlapp.util.camera.WebcamStreamListener;
...
public class WebcamView extends SurfaceView implements SurfaceHolder.Callback,
	...
	public void onBitmapReceived(Bitmap bitmap) {
		...
		if (canvas != null) {
			Rect src_rect = new Rect(0, 0, bitmap.getWidth(),
					bitmap.getHeight());
			Rect dest_rect = new Rect(0, 0, canvas.getWidth(),
					canvas.getHeight());
