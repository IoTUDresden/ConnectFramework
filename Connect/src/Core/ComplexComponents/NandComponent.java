...
public class NandComponent extends ActorComponent {
	
	public NandComponent() {
		super();
	...
	public NandComponent(String id) {
		super(id);
		// TODO Auto-generated constructor stub
	}
	...
	public void exec() {
		...
		this.getPort(PORT_ID_OUTPUT).setState(!(this.getPort(PORT_ID_INPUT1).getState() && this.getPort(PORT_ID_INPUT2).getState()));
		}
	}
